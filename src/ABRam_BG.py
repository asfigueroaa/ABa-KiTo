...
## Date: 03.09.2025
## Plain pythonv version of the 2025-07-25-Modifed-ABRam-BG.ipynb notebook
...
class Statistician(ap.Agent):
    ...
    def setup(self):
        ...
        Statistician.real_beta = self.p.beta0
        Statistician.real_gamma = self.p.gamma0
...
class Economy(ap.Model):
    ...
    def setup(self):
        ...
        self.farms = ap.AgentList(self, self.p['agents'], Farm, alpha = self.p['alpha'], 
                                   ...
                                   beta=self.p['beta0'], gamma= self.p['gamma0'],
                                   G0 = ap.AttrIter(self.p.G0),
                                   B0 = ap.AttrIter(self.p.B0) )
        #---------------------------------------------------------------
